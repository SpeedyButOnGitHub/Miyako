...
const baseTheme = {
  ...
  emojis: {
    info: 'ℹ️', success: '✅', warn: '⚠️', danger: '🚨', error: '❌',
    duration: '⏰', counter: '🧮', id: '🆔',
    create: '➕', delete: '➖', back: '⬅️', select: '🎯', events: '📅', times: '🕒', days: '📅',
    message: '📝', enable: '✅', disable: '🛑', toggle: '🔁', settings: '⚙️', edit: '✏️',
    profile: '👤', rank: '📊', leaderboard: '🏆', bank: '🏦', cash: '💸', deposit: '📈', withdraw: '📉',
    vc: '🎙️', text: '💬', action: '🧰', target: '🎯', moderator: '🛡️', mute: '🔇', unmute: '🔊', kick: '👢', ban: '🔨', close: '✖'
  }
};
